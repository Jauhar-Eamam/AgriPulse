      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-green-800">AgriTech</span>
          </Link>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-600">{t?.rememberMe || 'Remember me'}</span>
              </label>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500">{t?.orContinueWith || 'or continue with'}</span>
              </div>
            </div>
